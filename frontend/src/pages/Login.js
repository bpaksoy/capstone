            ...
            <div className="flex bg-white rounded-lg shadow-lg mx-auto max-w-sm lg:max-w-4xl min-h-[500px]">
                ...
                <div className="w-full p-8 lg:w-1/2 flex flex-col justify-center">
                    <div className="flex flex-col items-center mb-6">
                        <div className="bg-purple p-2.5 rounded-2xl shadow-xl mb-3">
                            <img src="/wormie-logo.svg" alt="" className="h-10 w-10 invert" />
                        </div>
                    ...
                    <div className="mt-4 flex items-center justify-between">
                        ...
                        <Link to="/register" className="text-xs text-[#17717d] hover:text-[#135f69] font-semibold uppercase">or sign up</Link>
                        <span className="border-b w-1/5 md:w-1/4"></span>
                    </div>
                </div>
            </div>
