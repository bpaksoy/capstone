                    ...
                    <div key={post.id} className="bg-white p-4 rounded-lg shadow-md max-w-2xl w-full mb-4 relative">
                        ...
                        <div className="flex items-center justify-between text-gray-500 mb-2">
                            ...
                            <button
                                ...
                                className="flex justify-center items-center gap-2 px-2 hover:bg-gray-50 rounded-full p-1 transition-colors duration-200"
                            >
                                ...
                                <span>{post.comment_count + (post.reply_count || 0)} Comment</span>
                            </button>
                        </div>
