                            ...
                            <Menu as="div" className="relative">
                                <div>
                                    ...
                                    >
                                        ...
                                        {unreadCount > 0 && (
                                            <span className={`absolute -top-1 -right-1 inline-flex items-center justify-center w-5 h-5 text-[10px] font-bold text-white bg-purple rounded-full border-2 border-gray-800 shadow-sm transition-all duration-500 ${showBadge ? 'animate-pulse scale-110 ring-2 ring-purple/20' : ''}`}>
