            ...
            <div className="relative flex flex-col rounded-3xl bg-white text-gray-700 shadow-xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 border border-gray-100 overflow-hidden h-full">
                ...
                <div className="relative aspect-video overflow-hidden shrink-0">
                    ...
                    <button
                        ...
                        className="absolute top-3 right-3 p-1.5 rounded-full bg-white/95 backdrop-blur-sm border border-gray-200 transition-all hover:bg-teal-50 shadow-sm group/btn"
                        type="button"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            className={`w-4 h-4 transition-all duration-300 ${isBookmarked ? 'fill-purple' : 'fill-transparent'}`}
                            stroke="#17717d"
                            strokeWidth="2.5"
                        >
