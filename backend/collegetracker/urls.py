...
urlpatterns = [
    ...
    path('api/users/public-students/',
         views.PublicStudentListView.as_view(), name='public-students'),
    ...
    path('api/notifications/mark-read/', views.NotificationMarkReadView.as_view(), name='notifications-mark-read'),
    path('api/notifications/count/', views.NotificationCountView.as_view(), name='notifications-count'),
    ...
    path('api/colleges/update-lead-status/', views.update_lead_status, name='update-lead-status'),
    path('api/colleges/<int:college_id>/announcements/', views.college_announcements, name='college-announcements'),
    path('api/colleges/<int:college_id>/ambassadors/', views.get_college_ambassadors, name='college-ambassadors'),
    path('api/colleges/<int:college_id>/follow/', views.toggle_follow_college, name='toggle-follow-college'),
    path('api/colleges/<int:college_id>/follow/check/', views.check_follow_college, name='check-follow-college'),
    path('api/ambassador/apply/', views.apply_as_ambassador, name='apply-ambassador'),
    path('api/colleges/<int:college_id>/pending-ambassadors/', views.get_pending_ambassadors, name='pending-ambassadors'),
    path('api/ambassador/verify/', views.verify_ambassador, name='verify-ambassador'),
    path('api/messages/send/', views.send_direct_message, name='send-direct-message'),
